    ...
    return (
        <div className='bg-white pb-5 rounded-lg overflow-hidden'>
            ...
            <section className='flex items-center justify-center gap-4 mt-4'>
                {/* buttons. */}
                <Button className='rounded-sm p-1 font-semibold' text={data.role==="user"?"Make Admin":"Make User"}/>
                <Button className='rounded-sm px-5 font-semibold bg-red-500' text={data.isBlocked?"Un-Block":"Block"}/>
            </section>
        </div>
    );
};
